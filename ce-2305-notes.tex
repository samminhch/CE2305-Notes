...
\begin{multicols}{2}
	...
	\end{definition}
	\begin{example}{$S=$\{\emoji{apple},\emoji{banana},\emoji{shark}\}}
		\begin{itemize}
...
\begin{multicols}{2}
    ...
    \end{definition}
    \begin{example}{$S=$\{\emoji{shrimp},\emoji{cooking},\emoji{rice}\}}
    \begin{itemize}
...
\begin{multicols}{2}
	\begin{minipage}{\linewidth}
		\centering
		\captionof{figure}{Complete Graph}
		\begin{graph}
			\node (1) {\emoji{apple}};
			\node (2) [below of=1] {\emoji{banana}};
			\node (3) [right of=1]{\emoji{cat}};
